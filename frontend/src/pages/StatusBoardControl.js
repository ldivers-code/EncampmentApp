...
const StatusBoardControl = () => {
  ...
  const canEdit = ['commander', 'executive_staff', 'staff', 'plans_programs', 'logistics', 'health_services', 'training_officer'].includes(user?.role);
  const canEmergency = ['commander', 'executive_staff'].includes(user?.role);
